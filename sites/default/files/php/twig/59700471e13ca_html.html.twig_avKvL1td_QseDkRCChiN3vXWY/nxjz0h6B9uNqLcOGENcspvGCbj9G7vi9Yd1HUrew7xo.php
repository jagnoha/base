...
class __TwigTemplate_d699fd49ee456456ff2cff6a2d0826d6e5aeccfd1fc1853ec0e1cd61264b0672 extends Twig_Template
{
...
<html ";
  ...
  <head>
    ...
    ";
        // line 64
        echo "    ";
        if (($this->getAttribute((isset($context["html_attributes"]) ? $context["html_attributes"] : null), "dir", array(), "array") == "rtl")) {
            // line 65
            echo "      ";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->env->getExtension('drupal_core')->attachLibrary("vartheme/global-styling-rtl"), "html", null, true));
            echo "
      ";
            // line 66
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->env->getExtension('drupal_core')->attachLibrary("vartheme/bootstrap-print-rtl"), "html", null, true));
            echo "
      ";
            // line 67
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->env->getExtension('drupal_core')->attachLibrary("vartheme/bootstrap-styling-rtl"), "html", null, true));
        }
        // line 69
...
<html {{ html_attributes }}>
  <head>
    ...
    {# attache global styling RTL (right to left) if the html tag has dir=rtl #}
    {% if html_attributes['dir'] == 'rtl' %}
      {{ attach_library('vartheme/global-styling-rtl') }}
      {{ attach_library('vartheme/bootstrap-print-rtl') }}
      {{ attach_library('vartheme/bootstrap-styling-rtl') }}
    {%- endif -%}
