...
/* profiles/varbase/modules/contrib/vmi/templates/horizontal-media-teaser/horizontal-media-teaser-xlarge.html.twig */
class __TwigTemplate_c3be8c11cb623b928dd731be8266819da46f3f16da6f1ef56f29377f5b94dd2c extends Twig_Template
{
...
";
        ...
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "horizontal-media-teaser-view-mode", 1 => "xlarge", 2 => "clearfix"), "method"), "html", null, true));
        echo ">
  ";
        // line 11
...
";
    ...
    {
        return "profiles/varbase/modules/contrib/vmi/templates/horizontal-media-teaser/horizontal-media-teaser-xlarge.html.twig";
    }
...
/**
 * @file
 * View modes inventory - Horizontal media teaser - xlarge template.
 */
#}
{% if title_suffix.contextual_links is not null %}
  {{ title_suffix.contextual_links }}
{% endif %}
<{{ outer_wrapper }}{{ attributes.addClass('horizontal-media-teaser-view-mode', 'xlarge', 'clearfix') }}>
  {% if left is not null %}
    <{{ left_wrapper }} class=\"left col-sm-8\">
      {{ content.left }}
    </{{ left_wrapper }}>
  {% endif %}
  {% if right is not null %}
    <{{ right_wrapper }} class=\"right col-sm-4\">
      {{ content.right }}
    </{{ right_wrapper }}>
  {% endif %}
</{{ outer_wrapper }}>
