...
/* {# inline_template_start #}{{ name }} ({{ nid }}) */
class __TwigTemplate_44bd7d505bd205e3a44d812044dc00fe40c975a9f370735a9f2ed9eb7df7f898 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}{{ name }} ({{ nid }})";
    }
