...
class __TwigTemplate_e2f50011ab18c4411edf4c177306fd23badc531e9b6c2618dee2d85651f6ca42 extends Twig_Template
{
  ...
  <head>
    ...
    ";
        ...
        if (($this->getAttribute((isset($context["html_attributes"]) ? $context["html_attributes"] : null), "dir", array(), "array") == "rtl")) {
            // line 43
            echo "      ";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->env->getExtension('drupal_core')->attachLibrary("vartheme_admin/global-admin-styling-rtl"), "html", null, true));
        }
        // line 45
...
<html{{ html_attributes }}>
  <head>
    ...
    {# Attache global admin styling RTL (right to left) #}
    {# if the html tag has dir=rtl #}
    {% if html_attributes['dir'] == 'rtl' %}
      {{ attach_library('vartheme_admin/global-admin-styling-rtl') }}
    {%- endif -%}
